...
class SignupPage extends Component {
  ...
  signup = async () => {
    ...
    this.props.firebase
      .doCreateUserWithEmailAndPassword(sendObject.email, sendObject.password)
      .then(authUser => {
            ...
            <Col sm={(8, 8, 12)} md={{ span: 8, order: 1 }}>
              <Card border="warning" className="cardit">
                <Card.Body className="centercard">
                  ...
                  <ButtonToolbar>
                    <Button variant="link">
                      <Image src={Google} height="50" />
                    </Button>
                    <Button variant="link">
                      <Image src={Facebook} height="50" />
                    </Button>
                  </ButtonToolbar>
                  ...
                  <div>
                    ...
                    <Button variant="outline-warning" onClick={this.signup}>
                      SIGN UP
                    </Button>
                  </div>
                </Card.Body>
